namespace AspNetCoreHero.Boilerplate.Application.Constants
{
    public static class Permissions
    {
        ...
        public static class RanksRewards
        {
            public const string View = "Permissions.Brands.View";
            public const string Create = "Permissions.Brands.Create";
            public const string Edit = "Permissions.Brands.Edit";
        ...
        {
            public const string View = "Permissions.Downloads.View";
            public const string Create = "Permissions.Downloads.Create";
            public const string Edit = "Permissions.Downloads.Edit";
            public const string Delete = "Permissions.Downloads.Delete";
        }
    }
}