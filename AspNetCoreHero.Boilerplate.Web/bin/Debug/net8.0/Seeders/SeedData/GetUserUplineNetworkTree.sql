--EXEC [App].[GetUserUplines] '292BF950-F37E-4C7A-B777-D9D028A0608C'

CREATE OR ALTER PROCEDURE [GetUserUplineNetworkTree]
...
BEGIN
    ...
    INNER JOIN
        RecursiveCTE ON N2.UserId = RecursiveCTE.ParentUserId
)
	INSERT INTO @Table
    SELECT
        UserId,
