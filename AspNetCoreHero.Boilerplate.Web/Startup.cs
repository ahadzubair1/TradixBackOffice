...
namespace AspNetCoreHero.Boilerplate.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var mailSettingsSection = _configuration.GetSection("MailSettings");
            services.Configure<MailSettings>(mailSettingsSection);

            var captchaSettingsSection = _configuration.GetSection("CaptchaSettings");
            services.Configure<CaptchaSettings>(captchaSettingsSection);

            var networkTreeSettingsSection = _configuration.GetSection("NetworkTreeSettings");
            services.Configure<NetworkTreeSettings>(networkTreeSettingsSection);
