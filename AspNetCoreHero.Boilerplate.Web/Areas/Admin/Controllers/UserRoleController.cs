...
namespace AspNetCoreHero.Boilerplate.Web.Areas.Admin.Controllers
{
    ...
    public class UserRoleController : BaseController<UserRoleController>
    {
        ...
        public UserRoleController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, RoleManager<IdentityRole> roleManager, ApplicationDbContext context)
        {
        ...
        public async Task<IActionResult> Update(string id, ManageUserRolesViewModel model)
        {
            ...
            await Infrastructure.Identity.Seeds.DefaultSuperAdminUser.SeedAsync(_userManager, _roleManager, _context);
