...
function initTheme() {
    ...
    if (darkThemeSelected) {
        ...
        $('#navigationBar').addClass('navbar-dark').addClass('bg-dark').removeClass('bg-white').removeClass('navbar-light');
        ...
        $('#navigationBar').removeClass('navbar-dark').removeClass('bg-dark').addClass('navbar-light').addClass('bg-white');
...
function resetTheme() {
    if (darkSwitch.checked) {
        ...
        $('body').addClass('dark-mode')
        $('#sideBar').addClass('sidebar-dark-primary').removeClass('sidebar-light-primary');
        $('#navigationBar').addClass('navbar-dark').addClass('bg-dark').removeClass('navbar-light').removeClass('bg-white');
        //$('.content-wrapper').attr('style', 'background-color: #111');
        //$('.card').attr('style', 'background-color: #212121');
        //$('.main-footer').attr('style', 'background-color: #212121');
        //$('.form-control').attr('style', 'background-color: #212121!important;color:white;border:1px solid #3c3c3c');
