(function($) {
    ...
    $.fn.orgChart.defaults = {
        data: [{id:1, name:'Root', parent: 0, position: "left"}],
        showControls: false,
        allowEdit: false,
        onAddNode: null,
        onDeleteNode: null,
        ...
        this.render = function(opts){
            ...
            if(childLength > 0){
                ...
                for (var i in self.children) {
                    ...
                    if (self.children[i].data.position === 'left') {
                        mainTable += "<td colspan='2'>" + self.children[i].render(opts) + "</td>";
                        //mainTable += "<td colspan='2'>" + /*self.children[i].render(opts)*/ "RIGHT" + "</td>";
                    }
                    else if (self.children[i].data.position === 'right') {
                        //mainTable += "<td colspan='2'>" + /*self.children[i].render(opts)*/ "LEFT" + "</td>";
                        mainTable += "<td colspan='2'>" + self.children[i].render(opts) + "</td>";
                    }
